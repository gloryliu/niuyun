 ...
 */
public class CommonPerfectInfoTagAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommonPerfectInfoTagAdapter1(Context context) {
        this.context = context;
        this.list = new ArrayList<>();
        mLayoutInflater = LayoutInflater.from(context);
    }

    public CommonPerfectInfoTagAdapter1(Context context, List<CommonTagItemBean> items) {
        this.context = context;
        this.list = new ArrayList<>();
