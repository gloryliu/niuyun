...
public class EditResumeWorkExperienceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EditResumeWorkExperienceAdapter(Context context) {
        this.context = context;
        this.list = new ArrayList<>();
        mLayoutInflater = LayoutInflater.from(context);
    }

    public EditResumeWorkExperienceAdapter(Context context, List<PreviewResumeBean.DataBean.ResumeWorkBean> items) {
        this.context = context;
        this.list = new ArrayList<>();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        if (list != null) {
            ((ImageViewHolder) viewHolder).tv_title.setText(list.get(position).getCompanyname());
