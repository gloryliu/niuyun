 ...
 */
public class EnterprisePublishedPisitionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private  List<EnterprisePublishedPositionBean.DataBeanX.DataBean> list;
    ...
    public EnterprisePublishedPisitionAdapter(Context context) {
        this.context = context;
        this.list = new ArrayList<>();
        mLayoutInflater = LayoutInflater.from(context);
    }

    public EnterprisePublishedPisitionAdapter(Context context, List<EnterprisePublishedPositionBean.DataBeanX.DataBean> items) {
        this.context = context;
        this.list = new ArrayList<>();
    ...
    public  List<EnterprisePublishedPositionBean.DataBeanX.DataBean> getEntities() {
        return list;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ImageViewHolder(mLayoutInflater.inflate(R.layout.fragment_index_position_list_item, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        if (list != null) {
            ...
            ((ImageViewHolder) viewHolder).tv_company_name.setVisibility(View.GONE);
