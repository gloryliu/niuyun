 ...
 */
public class JobPerfectInfoTagAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public JobPerfectInfoTagAdapter2(Context context) {
        this.context = context;
        this.list = new ArrayList<>();
        mLayoutInflater = LayoutInflater.from(context);
    }

    public JobPerfectInfoTagAdapter2(Context context, List<JobTagBean.DataBean> items) {
        this.context = context;
        this.list = new ArrayList<>();
