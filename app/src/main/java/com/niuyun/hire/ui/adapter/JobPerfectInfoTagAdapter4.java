 ...
 */
public class JobPerfectInfoTagAdapter4 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public JobPerfectInfoTagAdapter4(Context context) {
        this.context = context;
        this.list = new ArrayList<>();
        mLayoutInflater = LayoutInflater.from(context);
    }

    public JobPerfectInfoTagAdapter4(Context context, List<JobTagBean.DataBean> items) {
        this.context = context;
        this.list = new ArrayList<>();
