...
public class GroupManageConversation extends Conversation {
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()){
            case INVITED_BY_OTHER:
                if (isSelf){
                    return BaseContext.getInstance().getResources().getString(R.string.summary_me)+
                            BaseContext.getInstance().getResources().getString(R.string.summary_group_invite)+
                            to+
                            BaseContext.getInstance().getResources().getString(R.string.summary_group_add);
                }else{
                    if (to.equals(UserInfo.getInstance().getId())){
                        return from+
                                BaseContext.getInstance().getResources().getString(R.string.summary_group_invite)+
                                BaseContext.getInstance().getResources().getString(R.string.summary_me)+
                                BaseContext.getInstance().getResources().getString(R.string.summary_group_add);
                    }else{
                        return from+
                                BaseContext.getInstance().getResources().getString(R.string.summary_group_invite)+
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    return BaseContext.getInstance().getResources().getString(R.string.summary_me)+
                            BaseContext.getInstance().getResources().getString(R.string.summary_group_apply)+
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }else{
                    return from+BaseContext.getInstance().getResources().getString(R.string.summary_group_apply)+GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return BaseContext.getInstance().getString(R.string.conversation_system_group);
    }
