package com.niuyun.hire.ui.live.push;
...
//        mBtnVideoSrc = (Button) findViewById(R.id.btn_video_src);
//        mBtnVideoSrc.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if(mVideoSrc == VIDEO_SRC_SCREEN){
//                    mVideoSrc = VIDEO_SRC_CAMERA;
//                }
//                else mVideoSrc++;
//                switch (mVideoSrc){
//                    case VIDEO_SRC_CAMERA:
//                        mBtnVideoSrc.setBackgroundResource(R.drawable.video_press);
//                        break;
//                    case VIDEO_SRC_SCREEN:
//                        mBtnVideoSrc.setBackgroundResource(R.drawable.record_video);
//                        break;
//                }
//            }
//        });
