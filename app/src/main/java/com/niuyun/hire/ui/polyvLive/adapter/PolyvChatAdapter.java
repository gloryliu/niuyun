...
import com.niuyun.hire.ui.polyvLive.fragment.PolyvDanmuFragment;
import com.niuyun.hire.ui.polyvLive.util.PolyvTextImageLoader;
import com.niuyun.hire.ui.polyvLive.util.PolyvTimeUtils;
import com.niuyun.hire.ui.polyvLive.util.PolyvViewHolder;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        switch (message.getChatType()) {
            case PolyvChatMessage.CHATTYPE_RECEIVE:
                ...
                ImageLoadedrManager.getInstance().display(context,user.getPic(),iv_avatar);
                break;
