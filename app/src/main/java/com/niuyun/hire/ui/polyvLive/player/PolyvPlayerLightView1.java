...
public class PolyvPlayerLightView1 extends FrameLayout {
    //lightView
    private View view;
    private RelativeLayout rl_center_light;
    private TextView tv_light;

    public PolyvPlayerLightView1(Context context) {
        this(context, null);
    }

    public PolyvPlayerLightView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PolyvPlayerLightView1(Context context, AttributeSet attrs, int defStyleAttr) {
