package com.niuyun.hire.ui.polyvLive.util;
...
public class PolyvBitmapUtils {
    ...
    public static String saveBitmap(Bitmap bitmap, Context context) {
        ...
        try {
            saveFile = new File(getDiskCacheDir(context), "end.jpg");
            fos = new FileOutputStream(saveFile);
            bitmap = PolyvBitmapUtils.blur(context, bitmap, 25f);
        ...
        return result ? saveFile.getAbsolutePath() : null;
    }
