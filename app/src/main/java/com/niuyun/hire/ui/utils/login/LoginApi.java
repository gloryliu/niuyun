package com.niuyun.hire.ui.utils.login;
        ...
        switch (msg.what) {
            ...
            case MSG_AUTH_COMPLETE: {
                ...
                if (loginListener != null) {
                    loginListener.onRegister(getUser(plat));
                }
...
//				}
    ...
    private UserInfo getUser(String platform) {
        ...
        if (mPlatform != null) {
            ...
            if ("m".equals(gender)) {
                info.setUserGender(UserInfo.Gender.MALE);
            } else {
                info.setUserGender(UserInfo.Gender.FEMALE);
            }
            info.setUserIcon(mPlatform.getDb().getUserIcon());
            info.setUserName(mPlatform.getDb().getUserName());
            info.setUserNote(mPlatform.getDb().getUserId());
        }
        return info;
    }
}
