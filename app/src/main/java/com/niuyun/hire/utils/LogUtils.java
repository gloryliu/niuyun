...
public class LogUtils {
    ...
    public static String customTagPrefix = "jy_health_client_";
    static boolean debug = true;
    static int maxLogSize = 3000;

    static {
        //正式环境下关闭打印日志
//        debug = !((!TextUtils.isEmpty(RestAdapterManager.CacheAddressTag) && "1".equals(RestAdapterManager.CacheAddressTag) ));
        //若打开开关则打印日志
        debug=true;
    }
