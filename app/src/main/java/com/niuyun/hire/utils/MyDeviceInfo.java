...
public class MyDeviceInfo {
    private static Context context = BaseContext.getInstance();
    private static TelephonyManager telephonyManager = (TelephonyManager) (context.getSystemService(Context.TELEPHONY_SERVICE));
    ...
    public static String getDeviceId() {
        ...
        try {
            ...
            String imsi = getIMSI();
            String salt = getSALT(BaseContext.getInstance());
    ...
    public static String getDeviceIMEI() {
        String result = "";
        try {
            if (!checkPermissions(BaseContext.getInstance(), Manifest.permission.READ_PHONE_STATE)) {
                return "";
            }
