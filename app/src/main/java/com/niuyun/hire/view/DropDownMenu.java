...
//        containerView.addView(contentView, 0);
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        final  LinearLayout tabLinearLayout=new LinearLayout(getContext());
        tabLinearLayout.setGravity(Gravity.CENTER);
        tabLinearLayout.setLayoutParams(new LayoutParams( 0, dpTpPx(45),1.0f));
        ...
        tab.setCompoundDrawablePadding(dpTpPx(7));
...
//        tab.setPadding(dpTpPx(5), dpTpPx(12), dpTpPx(5), dpTpPx(12));
        ...
        tabLinearLayout.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                switchMenu(tabLinearLayout);
            }
        });
        tabLinearLayout.addView(tab);
        tabMenuView.addView(tabLinearLayout);
        //添加分割线
