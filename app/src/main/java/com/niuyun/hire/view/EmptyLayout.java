...
public class EmptyLayout {
    ...
    private int mErrorMessageViewId= R.id.textViewMessage;
    private int mEmptyMessageViewId=R.id.textViewMessage;
    private int mLoadingMessageViewId=R.id.textViewMessage;
    ...
    private String mErrorMessage = "页面找不到了\n请稍后重试";
    private String mEmptyMessage = "没有找到您想要的信息";
    private String mLoadingMessage = "Please wait";
    private int loadingIcon=R.mipmap.ic_loading;
    private int emptyIcon=R.mipmap.ic_empty;
    private int errorIcon=R.mipmap.ic_error;
    private int loadingIconId=R.id.imageViewLoading;
    private int emptyIconId= R.id.empty_img;
    private int errorIconId=R.id.error_img;
    ...
    private String emptyBtnMsg="逛逛首页";
    ...
    /**
     * @param errorIcon set error img resource
     */
    ...
    public void setEmptyBtnMsg(String msg){
        this.emptyBtnMsg=msg;
    }
    /**
     * Sets the message to be shown when the list will be empty for not having any item to display
     *
    ...
    /**
     * @param emptyIcon set empty img resource
     */
    ...
    /**
     * @param loadingIcon set loading img resource
     */
    public void setLoadingIcon(int loadingIcon) {
     ...
     */
    public void setLoadingClickListener(View.OnClickListener loadingButtonClickListener) {
     ...
     */
    public void setEmptyClickListener(View.OnClickListener emptyButtonClickListener) {
     ...
     */
    public void setErrorClickListener(View.OnClickListener errorButtonClickListener) {
    ...
    private void changeEmptyType() {
        ...
        switch (mEmptyType) {
            ...
            case TYPE_LOADING:
                ...
                /*	cpb=(CircularProgressBar) mLoadingView.findViewById(R.id.circularProgressBar);
                    mLoadingView.setVisibility(View.VISIBLE);
    ...
    private void refreshMessages() {
        ...
        if (emptyIcon > 0 )
            ( (ImageView) mEmptyView.findViewById(emptyIconId)).setImageResource(emptyIcon);
        if (loadingIcon > 0 )
            ( (ImageView) mLoadingView.findViewById(loadingIconId)).setImageResource(loadingIcon);
        if (errorIcon > 0)
            ( (ImageView) mErrorView.findViewById(errorIconId)).setImageResource(errorIcon);
    }
    ...
    private void setDefaultValues() {
        if (mEmptyView == null) {
            ...
            if (mShowEmptyButton && mEmptyViewButtonId > 0 && mEmptyButtonClickListener != null) {
                TextView emptyViewButton = (TextView) mEmptyView.findViewById(mEmptyViewButtonId);
                emptyViewButton.setText(emptyBtnMsg);
        ...
        if (mErrorView == null) {
            ...
            if (mShowErrorButton && mErrorViewButtonId > 0 && mErrorButtonClickListener != null) {
                View errorViewButton = mErrorView.findViewById(R.id.buttonError);
